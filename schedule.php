<!DOCTYPE html>
<html>
<style >body {background-repeat: no repeat; text-transform: uppercase; font-family: Arial, Helvetica, sans-serif;
  background-size: 100%;
}
	table{
	...
	<table align="center">
		...
		<tr align="center" width="300%" style="margin-top:200px;">
		 <div style="margin-top:50px; font-size:30px;">
            ...
            <input type="number" style=font-size:25px; name="match_no"><br></br>
